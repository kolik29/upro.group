...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 28 2020 г., 19:27
...
INSERT INTO `automobiles` (`id`, `Brand`, `Model`, `Year`) VALUES
(36, 'Lada', 'Vesta', '2012'),
(37, 'Toyota', 'Corola', '2009'),
(38, 'Toyota', 'Camry', '1998'),
(39, 'UAZ', 'Patriot', '2007'),
(40, 'Карета', 'Упряжная', '1845');
...
(1, 'admin', 'admin@example.com', NULL, '$2y$10$MA3iratfQvGNGr2S16so3O64KX42gQ8PYCE2JwYZ4uUaciUaH09dK', NULL, '2020-06-27 08:26:41', '2020-06-27 08:26:41');
